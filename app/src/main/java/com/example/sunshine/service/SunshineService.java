...
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String units = "metric";
        int numDays = 14;
        String key = "5e27c6ba3c9f8273c969b85ff75bbd3a";
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor.moveToFirst()) {
            ...
            getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
    ...
    private Cursor getCursor(String locationSetting) {
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i("AlarmReceiver", "AlarmReceiver: onReceive");
